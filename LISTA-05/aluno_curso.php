...
class vinculo_aluno_e_curso {
    ...
    function getAll() {
        $sql = "SELECT 
            ...
            id_aluno,
            id_curso,
            DATE_FORMAT(ac.data_cadastro, '%d/%m/%Y %H:%i:%s') data_cadastro
        FROM vinculo_aluno_e_curso ac
        inner join aluno a on (ac.id_aluno = a.id)
...
$pessoa = new vinculo_aluno_e_curso($conn);
